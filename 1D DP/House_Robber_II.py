...
# You are planning to rob money from the houses but you cannot rob two adjacent houses because the secuurity system will automatically call the police if two adjacennt houses were both broken into
...
print(rob(nums2)) # Expected output: 15
